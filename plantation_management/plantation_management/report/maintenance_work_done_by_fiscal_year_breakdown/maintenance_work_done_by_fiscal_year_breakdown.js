frappe.query_reports["Maintenance Work Done By Fiscal Year Breakdown"] = {
  "filters": [
    {
  ...
  formatter: function (value, row, column, data, default_formatter) {
    if (column.fieldname !== "plantation_serial_shortform" || !value || !data) {
      return default_formatter(value, row, column, data);
    }

    const full_name = data.plantation_serial || value;
    const short = data.plantation_serial_shortform || value;
